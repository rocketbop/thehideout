...
function load_fonts() {
        ...
        wp_register_style('googleFonts', 'http://fonts.googleapis.com/css?family=Oswald:400,300,700|Quattrocento:400,700|Oxygen:300,400,700|Playfair+Display:400,700,900|Lato:300,400,700,900|Merriweather:400,300,700|Berkshire+Swash|Halant:300,400,500,600,700|Kameron|PT+Serif:400,700|PT+Sans+Narrow|Open+Sans+Condensed:200|Source+Sans+Pro:200,300, 400');
...
function hideout_scripts() {
	...
	wp_enqueue_script( 'angular-filter', get_template_directory_uri() . '/angular/bower_components/angular-filter/dist/angular-filter.min.js', false, NULL);
  ...
  wp_enqueue_script( 'angular-facebook', get_template_directory_uri() . '/angular/bower_components/angular-facebook/lib/angular-facebook.js', false, NULL);
